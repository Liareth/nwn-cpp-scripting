...
struct IOperation
{
    virtual std::vector<uint8_t> bytes(const uintptr_t address) const = 0;
};
...
struct AddRegImmByteInstruction final : public IInstruction
{
    ...
    virtual std::vector<uint8_t> bytes(const uintptr_t address = 0) const override;
...
struct CallRelInstruction final : public IInstruction
{
    ...
    virtual std::vector<uint8_t> bytes(const uintptr_t address) const override;
